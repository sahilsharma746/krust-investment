        ...
        return (
            ...
            (u.prototype.extractData = function () {
                ...
                e.forEach((e) => {
                    ...
                    else s = { text: e.innerText, value: e.value, selected: null != e.getAttribute("selected") || this.el.value == e.value, disabled: null != e.getAttribute("disabled"), icon: e.hasAttribute("data-icon") ? e.getAttribute("data-icon") : null, image: e.hasAttribute("data-img") ? e.getAttribute("data-img") : null };
                    var o = { selected: e.selected, disabled: e.disabled, optgroup: "OPTGROUP" == e.tagName, icon: e.hasAttribute("data-icon") ? e.getAttribute("data-icon") : null, image: e.hasAttribute("data-img") ? e.getAttribute("data-img") : null };
                ...
                if (this.multiple) {
                    ...
                    this.config.showSelectedItems || this.config.showSelectedItems || "auto" == window.getComputedStyle(this.dropdown).width || this.selectedOptions.length < 2
                        ? (this.selectedOptions.forEach(function (t) {
                            let content = t.data.text;
                            e += `<span class="current">${content}</span>`;
                        }),
                            (e = "" == e ? this.placeholder : e))
                        : (e = (this.selectedOptions.length - 1) + " " + this.selectedtext),
            ...
            (u.prototype._renderItem = function (e) {
                ...
                if (e.data.image !== null && e.data.image !== undefined && e.data.image != "") {
                    content = `<img src="${e.data.image}"  class="option-image">${e.data.text}`;
                }
                else if (e.data.icon !== null && e.data.icon !== undefined && e.data.icon != "") {
                    content = `<i class="${e.data.icon} option-icon"></i>${e.data.text}`;
                }
                if (((t.innerHTML = content), e.attributes.optgroup)) c(t, "optgroup");
                else {
