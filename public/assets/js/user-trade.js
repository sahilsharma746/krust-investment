...
function show_crypto_assets_marketwacth(apiUrl){
    ...
    .then(data => {
        ...
        data.forEach(pair => {
            ...
            table_row_html += '<img src="' + pair.image + '" class="icon crypto_image" alt="' + pair.name + '" style="width: 30px; height: 30px;">';
            table_row_html += '<span>' + pair.name + '</span>';
            table_row_html += '</div>';
            table_row_html += '</td>';
            table_row_html += '<td>' + pair.market_cap.toLocaleString() + '</td>';
            table_row_html += '<td>' + pair.fully_diluted_valuation.toLocaleString() + '</td>';
            table_row_html += '<td>' + pair.current_price.toFixed(2) + '</td>';
            table_row_html += '<td>' + pair.total_volume.toLocaleString() + '</td>';
            table_row_html += '<td>' + pair.circulating_supply.toLocaleString() + '</td>';
            table_row_html += '<td style="color: ' + (pair.price_change_percentage_24h < 0 ? 'red' : 'green') + ';">' + pair.price_change_percentage_24h.toFixed(2) + '%</td>';
            table_row_html += '</tr>';
