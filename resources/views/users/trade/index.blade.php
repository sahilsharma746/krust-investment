                            ...
                            <dl id="trade-and-market-common-table" class="trade-and-market-common-table scroll">
                                <dt class="d-flex justify-content-between align-items-center g-10 asset-data">
                                    <div class="country-name d-flex align-items-center g-8">
                                        ...
                                        <span data-name="EURUSD" data-fullname="EURO / U.S. DOLLAR">EURUSD</span>
                                    </div>
                                ...
                                <dt class="d-flex justify-content-between align-items-center g-10 asset-data">
                                    <div class="country-name d-flex align-items-center g-8">
                                        ...
                                        <span data-name="GBPUSD" data-fullname="BRITISH POUND / U.S. DOLLAR">GBPUSD</span>
                                    </div>
                                    <div class="price">1.0953</div>
                                ...
                                <dt class="d-flex justify-content-between align-items-center g-10 asset-data">
                                    <div class="country-name d-flex align-items-center g-8">
                                        <img src="{{ asset('assets') }}/img/country-eur.png" alt="country flag" class="flag">
                                        <span data-name="EURUAH" data-fullname="EURO / UKRAINIAN HRYVNIA">EURUAH</span>
                                    </div>
                                    <div class="price">1.0953</div>
                                    <div class="percentage text-success">+0.77%</div>
                                </dt>
                                <dt class="d-flex justify-content-between align-items-center g-10 asset-data">
                                    <div class="country-name d-flex align-items-center g-8">
                                        <img src="{{ asset('assets') }}/img/country-eur.png" alt="country flag" class="flag">
                                        <span data-name="USDUAH" data-fullname="U.S. DOLLAR / UKRAINIAN HRYVNIA">USDUAH</span>
                                    </div>
                                    <div class="price">1.0953</div>
                                    <div class="percentage text-danger">+0.77%</div>
                                </dt>
                                <dt class="d-flex justify-content-between align-items-center g-10 asset-data">
                                    <div class="country-name d-flex align-items-center g-8">
                                        <img src="{{ asset('assets') }}/img/country-eur.png" alt="country flag" class="flag">
                                        <span data-name="GBPUAH" data-fullname="BRITISH POUND / UKRAINIAN HRYVNIA">GBPUAH</span>
                                    </div>
                                    <div class="price">1.0953</div>
                                    <div class="percentage text-success">+0.77%</div>
                                </dt>
                                <dt class="d-flex justify-content-between align-items-center g-10 asset-data">
                                    <div class="country-name d-flex align-items-center g-8">
                                        <img src="{{ asset('assets') }}/img/country-eur.png" alt="country flag" class="flag">
                                        <span data-name="CHFUAH" data-fullname="SWISS FRANC / UKRAINIAN HRYVNIA">CHFUAH</span>
                                    </div>
                                    <div class="price">1.0953</div>
                                    <div class="percentage text-danger">+0.77%</div>
                                </dt>
                                <dt class="d-flex justify-content-between align-items-center g-10 asset-data    ">
                                    <div class="country-name d-flex align-items-center g-8">
                                        <img src="{{ asset('assets') }}/img/country-eur.png" alt="country flag" class="flag">
                                        <span data-name="USDSIT" data-fullname="U.S. DOLLAR / SLOVENIAN TOLAR">USDSIT</span>
                                    </div>
                                    <div class="price">1.0953</div>
                                    <div class="percentage text-danger">+0.77%</div>
                                </dt>
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                ...
                                <div class="payout-area d-grid">
                                    ...
                                    <span class="text-end text-primary">$108,00.45</span>
                                </div>
                            </div>
                        </div>
                    </div>
