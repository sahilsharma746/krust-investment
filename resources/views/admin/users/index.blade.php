                                ...
                                <div class="dropdown w-max">
                                    ...
                                    <ul class="list-style-none dropdown-menu d-flex flex-column">
                                        <li class="dropdown-item">
                                            <a class="btn" href="{{ route('admin.user.details', $data->id) }}">View User</a>
                                            <a class="btn" href="{{ route('admin.user.editBalance', $data->id) }}">Edit balance</a>
                                            <a class="btn" href="{{ route('admin.user.banUser', $data->id) }}">Ban User</a>
                                            <a class="btn" href="{{ route('admin.user.deleteUser', $data->id) }}">Delete User</a>
                                        </li>
                                    </ul>
                                </div>
